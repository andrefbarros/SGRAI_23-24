                ...
                if (this.maze.foundExit(this.player.position)) {
                    ...
                    */ 
                    if (this.player.keyStates.backward) { // The player is moving backward
                        const x = coveredDistance * Math.sin(direction);
                        const y = this.player.position.y;
                        const z = coveredDistance * Math.cos(direction);
                    ...
                    this.player.object.rotation.set(0, direction - this.player.initialDirection, 0);
                }
            }
