    ...
    update(deltaT) {
        ...
        if (centerIncrement.x < 0.0) {
            if (this.center.x - this.radius < this.player1.center.x + this.player1.halfSize.x && 
                ...
                this.center.y > this.player1.center.y - this.player1.halfSize.y && 
                this.center.y < this.player1.center.y + this.player1.halfSize.y) {
        ...
        /* To-do #12 - Check if the ball hit player 2 racket
            ...
            if (this.center.x + this.radius > this.player2.center.x - this.player2.halfSize.x && this.center.x + this.radius < this.player2.center.x + this.player2.halfSize.x && this.center.y > this.player2.center.y - this.player2.halfSize.y && this.center.y < this.player2.center.y + this.player2.halfSize.y) {
                this.direction = Math.PI - this.direction;
            }
        }
        ...
        if ((centerIncrement.y < 0.0 && ((this.center.y - this.radius) < -this.table.halfSize.y)) || (centerIncrement.y > 0.0 && ((this.center.y + this.radius) > this.table.halfSize.y))) {
